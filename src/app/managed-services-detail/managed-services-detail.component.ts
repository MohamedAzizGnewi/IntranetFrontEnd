...
@Component({
  selector: 'app-managed-services-detail',
  templateUrl: './managed-services-detail.component.html',
  styleUrls: ['./managed-services-detail.component.css']
})
export class ManagedServicesDetailComponent implements OnInit {
