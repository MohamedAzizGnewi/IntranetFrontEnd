...
@Component({
  selector: 'app-professional-services-detail',
  templateUrl: './professional-services-detail.component.html',
  styleUrls: ['./professional-services-detail.component.css']
})
export class ProfessionalServicesDetailComponent implements OnInit {
